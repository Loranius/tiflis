...
const Reserve = {
  ...
  _renderModal(info) {
    ...
    showModal(`
      ...
      <div id="rb-new-form" style="${hasBookings ? 'display:none;' : ''}border-top:1px solid rgba(255,255,255,.08);padding-top:16px;margin-top:${hasBookings ? '0' : '0'}px">
        <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;
