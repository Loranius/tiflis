...
`Loranius/tiflis` — активний репозиторій порталу персоналу ресторану «Тифліс».
Архівна vanilla-версія збережена в окремій гілці та в `Loranius/tiflisold` лише як джерело поведінки під час міграції модулів.
